...
siren:	
	cmp #2, &siren_state	;should not borrow comparison
	jhs break		;jump out if siren_state > 1
	mov &siren_state, r12	;move static var in r12
	add r12,r12		;allow for proper indexing for shorts
	mov jt(r12), r0		;move whatever is at jt at index r12 into our program counter
case0:
